# Python script to generate and run fast V11 rebuild reusing V10 assets
import os
...
with open('rebuild_v11.sh', 'w', encoding='utf-8', newline='\n') as f:
    f.write(script_content)

print('Successfully created rebuild_v11.sh')
